...
int main() {
    ...
    /* Читаем все рёбра, записываем их в вектор и сортируем */
    cin >> n >> m;
    vector<cable> v;
    ...
    /* Добавляем вершины (хабы) в граф, каждой вершине присваивая номер подграфа, не соединённого с другими подграфами */
    /* Если объединяем два подграфа, то присваиваем новому номер наименьшего из двух */
    /* Делаем так до тех пор, пока не соединим все вершины графа */
    short used_points[n];
